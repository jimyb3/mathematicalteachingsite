...
var ddaccordion={
	...
	expandit:function($targetHeader, $targetContent, config, useractivated, directclick){
                ...
                $targetContent.find(".spoilerimage").each(function () {
                    var $href = $(this).attr("data_src"); //адрес изображеения упакованая в атрибут data_src
                    ...
                    $(this).removeAttr("data_src"); //удаляем атрибут data_src, все остальное делается внизу скрипта после загрузки изображеня
                  }                                       
                });
